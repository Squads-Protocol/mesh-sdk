...
const mesh_json_1 = __importDefault(require("./mesh-idl/mesh.json"));
...
class SquadsMesh {
    constructor({ connection, wallet, multisigProgramId, }) {
        ...
        this.multisig = new anchor_1.Program(mesh_json_1.default, this.multisigProgramId, this.provider);
    }
    static endpoint(endpoint, wallet, options) {
        return new SquadsMesh(Object.assign({ connection: new web3_js_1.Connection(endpoint, options === null || options === void 0 ? void 0 : options.commitmentOrConfig), wallet }, options));
    }
    static mainnet(wallet, options) {
        return new SquadsMesh(Object.assign({ connection: new web3_js_1.Connection("https://api.mainnet-beta.solana.com", options === null || options === void 0 ? void 0 : options.commitmentOrConfig), wallet }, options));
    }
    static devnet(wallet, options) {
        return new SquadsMesh(Object.assign({ connection: new web3_js_1.Connection("https://api.devnet.solana.com", options === null || options === void 0 ? void 0 : options.commitmentOrConfig), wallet }, options));
    }
    static localnet(wallet, options) {
        return new SquadsMesh(Object.assign({ connection: new web3_js_1.Connection("http://localhost:8899", options === null || options === void 0 ? void 0 : options.commitmentOrConfig), wallet }, options));
    }
    ...
    _createMultisig(externalAuthority, threshold, createKey, initialMembers) {
        ...
        return [
            this.multisig.methods
                .create(externalAuthority, threshold, createKey, initialMembers)
                .accounts({ multisig: multisigPDA, creator: this.wallet.publicKey }),
            multisigPDA,
        ];
    }
    createMultisig(externalAuthority, threshold, createKey, initialMembers) {
        return __awaiter(this, void 0, void 0, function* () {
            const [methods, multisigPDA] = this._createMultisig(externalAuthority, threshold, createKey, initialMembers);
            yield methods.rpc();
            return yield this.getMultisig(multisigPDA);
        });
    }
    buildCreateMultisig(externalAuthority, threshold, createKey, initialMembers) {
        return __awaiter(this, void 0, void 0, function* () {
            const [methods] = this._createMultisig(externalAuthority, threshold, createKey, initialMembers);
    ...
    _addInstruction(multisigPDA, transactionPDA, instruction, instructionIndex, authorityIndex, authorityBump, authorityType) {
        return __awaiter(this, void 0, void 0, function* () {
            const [instructionPDA] = (0, address_1.getIxPDA)(transactionPDA, new bn_js_1.default(instructionIndex, 10), this.multisigProgramId);
            return [
                this.multisig.methods
                    .addInstruction(instruction, authorityIndex || null, authorityBump || null, authorityType === "custom" ? { custom: {} } : { default: {} })
                    .accounts({
                    multisig: multisigPDA,
                    transaction: transactionPDA,
    ...
    addInstruction(transactionPDA, instruction, authorityIndex, authorityBump, authorityType) {
        return __awaiter(this, void 0, void 0, function* () {
            const transaction = yield this.getTransaction(transactionPDA);
            const [methods, instructionPDA] = yield this._addInstruction(transaction.ms, transactionPDA, instruction, transaction.instructionIndex + 1, authorityIndex, authorityBump, authorityType);
            yield methods.rpc();
            return yield this.getInstruction(instructionPDA);
        });
    }
    buildAddInstruction(multisigPDA, transactionPDA, instruction, instructionIndex, authorityIndex, authorityBump, authorityType) {
        return __awaiter(this, void 0, void 0, function* () {
            const [methods] = yield this._addInstruction(multisigPDA, transactionPDA, instruction, instructionIndex, authorityIndex, authorityBump, authorityType);
            return yield methods.instruction();
        });
    }
    ...
    _addMember(multisig, externalAuthority, newMember) {
        return __awaiter(this, void 0, void 0, function* () {
            const method = yield this.multisig.methods.addMember(newMember)
                .accounts({
                multisig,
                externalAuthority,
            });
    ...
    addMember(multisig, externalAuthority, newMember) {
        return __awaiter(this, void 0, void 0, function* () {
            const method = yield this._addMember(multisig, externalAuthority, newMember);
            return method.rpc();
        });
    }
    // add a member, returns instruction for when the 
    // external authority is a default authority
    buildAddMember(multisig, externalAuthority, newMember) {
        return __awaiter(this, void 0, void 0, function* () {
            const method = yield this._addMember(multisig, externalAuthority, newMember);
    ...
    _removeMember(multisig, externalAuthority, exMember) {
        return __awaiter(this, void 0, void 0, function* () {
            const method = yield this.multisig.methods.removeMember(exMember)
                .accounts({
                multisig,
                externalAuthority,
            });
    ...
    // add a member, directly invoke from the external authority
    removeMember(multisig, externalAuthority, exMember) {
        return __awaiter(this, void 0, void 0, function* () {
            const method = yield this._removeMember(multisig, externalAuthority, exMember);
            return method.rpc();
        });
    }
    // add a member, returns instruction for when the 
    // external authority is a default authority
    buildRemoveMember(multisig, externalAuthority, exMember) {
        return __awaiter(this, void 0, void 0, function* () {
            const method = yield this._removeMember(multisig, externalAuthority, exMember);
            return method.instruction();
        });
    ...
    // the core remove member method
    _changeThreshold(multisig, externalAuthority, newThreshold) {
        return __awaiter(this, void 0, void 0, function* () {
            const method = yield this.multisig.methods.changeThreshold(newThreshold)
                .accounts({
                multisig,
                externalAuthority,
            });
    ...
    // external auth internal functions
    // add a member, directly invoke from the external authority
    changeThreshold(multisig, externalAuthority, newThreshold) {
        return __awaiter(this, void 0, void 0, function* () {
            const method = yield this._changeThreshold(multisig, externalAuthority, newThreshold);
            return method.rpc();
        });
    }
    // add a member, returns instruction for when the 
    // external authority is a default authority
    buildChangeThresholdMember(multisig, externalAuthority, newThreshold) {
        return __awaiter(this, void 0, void 0, function* () {
            const method = yield this._changeThreshold(multisig, externalAuthority, newThreshold);
            return method.instruction();
        });
    ...
    _changeExternalAuthority(multisig, externalAuthority, newExternalAuthority) {
        return __awaiter(this, void 0, void 0, function* () {
            const method = yield this.multisig.methods.changeExternalAuthority(newExternalAuthority)
                .accounts({
                multisig,
                externalAuthority,
            });
    ...
    changeExternalAuthority(multisig, externalAuthority, newExternalAuthority) {
        return __awaiter(this, void 0, void 0, function* () {
            const method = yield this._changeExternalAuthority(multisig, externalAuthority, newExternalAuthority);
            return method.rpc();
        });
    }
    // build instruction for the external authority
    buildChangeExternalAuthority(multisig, externalAuthority, newExternalAuthority) {
        return __awaiter(this, void 0, void 0, function* () {
            const method = yield this._changeExternalAuthority(multisig, externalAuthority, newExternalAuthority);
            return method.instruction();
        });
